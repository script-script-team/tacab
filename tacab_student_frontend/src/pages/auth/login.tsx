      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            <label className="font-[500] text-gray-600">ID numberka</label>
            <Input onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.id} name="id" type="text" placeholder="Gali ID numberkaaga" />
            <p className="text-red-500 font-bold">{formik.touched.id && formik.errors.id}</p>
          </div>
        <div className="flex flex-col gap-2">
          <label className="font-[500] text-gray-600">Numberka sirta</label>
          <Input onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.pass} name="pass" type="password" placeholder="Gali numberkaaga sirta ah" />
